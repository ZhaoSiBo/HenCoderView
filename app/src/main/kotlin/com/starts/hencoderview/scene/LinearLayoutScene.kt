...
import com.starts.hencoderview.databinding.LineralayoutUiTestBinding
import com.starts.hencoderview.util.ARGUMENTS_STRING_TITLE
import timber.log.Timber

class LinearLayoutScene : AppCompatScene() {
    lateinit var binding:LineralayoutUiTestBinding
    ...
    override fun onCreateContentView(p0: LayoutInflater, p1: ViewGroup, p2: Bundle?): View {
        ...
        binding = LineralayoutUiTestBinding.inflate(p0)
