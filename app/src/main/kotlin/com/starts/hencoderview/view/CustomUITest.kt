...
class CustomUITest(context: Context) : CustomLayout(context) {
    ...
    private val topImg = ImageView(context).apply {
    ...
    private val floatingActionButton = FloatingActionButton(context).apply {
    ...
    private val introduce = TextView(context).apply {
        layoutParams = LayoutParams(wrapContent, wrapContent)
    ...
    private val share = ImageView(context).apply {
    ...
    override fun onMeasureChildren(widthMeasureSpec: Int, heightMeasureSpec: Int): Dimension {
        ...
        share.autoMeasure()
        introduce.measure(
            widthMeasureSpec - avatar.measuredWidth - share.measuredWidth - 4 * commonMargin,
            Int.MAX_VALUE.toAtMostMeasureSpec()
        )
